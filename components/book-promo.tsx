...
const ebooks = [
  {
    id: "2",
    title: "Guía de Asertividad",
    tagline: "Aprende a comunicarte con confianza",
    color: "from-[#8dbda2]/20 to-[#8dbda2]/5",
    accent: "#8dbda2",
    href: "/tienda/guia-asertividad",
    image: "/images/ProductoDigital1.jpeg",
    price: "$9.99",
  },
  {
    id: "3",
    title: "Guía de Autocuidado",
    tagline: "30 días para cuidarte de verdad",
    color: "from-[#6ea9c2]/20 to-[#6ea9c2]/5",
    accent: "#6ea9c2",
    href: "/tienda/guia-de-autocuidado",
    image: "/images/ProductoDigital1.jpeg",
    price: "$9.99",
  },
  {
    ...
    tagline: "Tu espacio para escribir y crecer",
    color: "from-[#e8aea3]/20 to-[#e8aea3]/5",
    accent: "#e8aea3",
    href: "/tienda/diario-de-bienestar",
    image: "/images/ProductoDigital1.jpeg",
    price: "$7.99",
  },
]
...
export function BookPromo() {
  ...
  return (
    <section id="tienda-promo" className="relative overflow-hidden py-20 md:py-32">
      {/* Decorative blobs */}
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-xl leading-relaxed text-foreground/80">
            Recursos creados desde la experiencia clínica para acompañarte en tu proceso de autoconocimiento, tanto si estás en terapia como si empiezas tu camino solo.
          </p>
        </motion.div>
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          >
            <Link href="/tienda/conocete-y-comienza-a-quererte" className="group block h-full">
              <div className="relative flex h-full flex-col overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#A7895C]/20 via-[#A7895C]/10 to-transparent p-8 shadow-sm transition-shadow duration-500 hover:shadow-xl">
                ...
                <div className="order-4 lg:order-4 mt-auto lg:mt-2">
                  <p className="text-sm leading-relaxed text-[#5c4b32]/80">
                    Un viaje hacia tu bienestar emocional. Acompañamiento desde la psicología aplicada a tu vida cotidiana.
                  </p>
                  <div className="mt-6 flex items-center justify-between">
                    <span className="font-serif text-3xl font-bold text-[#A7895C]">$29.99</span>
            ...
            {ebooks.map((ebook, i) => (
              ...
              >
                <div className="group flex items-center gap-5 rounded-2xl bg-card p-5 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                  ...
                  <Link href={ebook.href} className="relative flex h-20 w-16 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl">
                    <div className={`absolute inset-0 bg-gradient-to-br ${ebook.color}`} />
                    <Image
                      src={ebook.image}
                      alt={ebook.title}
                      fill
                  ...
                  <Link href={ebook.href} className="flex flex-1 flex-col gap-0.5 min-w-0">
                    <p className="text-xs font-semibold uppercase tracking-wider" style={{ color: ebook.accent }}>
                      E-Book
                    </p>
                    <h4 className="font-serif text-lg font-bold text-foreground leading-tight">
                      {ebook.title}
                    </h4>
                    <p className="text-sm text-foreground/60 line-clamp-1">{ebook.tagline}</p>
                  </Link>

                  {/* Price & Add to Cart */}
                  <div className="flex flex-shrink-0 flex-col items-end gap-2">
                    <span className="font-serif text-xl font-bold text-[#A7895C]">{ebook.price}</span>
                    <button
                      onClick={() => {
